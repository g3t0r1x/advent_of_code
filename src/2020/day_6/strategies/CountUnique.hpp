...
#ifndef __SRC__2020__DAY_6__COUNTUNIQUE_HPP__
#define __SRC__2020__DAY_6__COUNTUNIQUE_HPP__
...
class CountUnique : public ICountingStrategy, public std::enable_shared_from_this<CountUnique>
{
public:
...
#endif // __SRC__2020__DAY_6__COUNTUNIQUE_HPP__
